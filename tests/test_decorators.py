...
class BaseDecoratorTestCase(object):
    def setUp(self):
        ...
        self.model = install('partition', orm='peewee')(self.model)
...
class InstallDecoratorTestCase(BaseDecoratorTestCase, unittest.TestCase):
    def test_merges_several_features(self):
        ...
        self.model = install('operation', orm='peewee')(self.model)
    ...
    def test_gathers_original_method(self):
        ...
        self.childmodel = install('partition', orm='peewee')(self.childmodel)
    ...
    def test_raises_feature_install_error(self):
        ...
        self.assertRaises(FeatureInstallError, lambda: install('foo', orm='peewee')(self.model))

    def test_raises_method_autodecorate_error(self):
        from architect.exceptions import MethodAutoDecorateError as MADError
        self.assertRaises(MADError, lambda: install('partition', orm='peewee')(mock.Mock(spec=['__name__'])))
